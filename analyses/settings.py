TRACK_WORDS = ['musichackathon','music','community','lab','data','accessability','hacking']#music_data, musichackathon, accessability, hacking, musicommunitylab, spotify, MIR
TABLE_NAME = "twitter"
